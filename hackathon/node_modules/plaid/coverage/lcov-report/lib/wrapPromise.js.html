...
<html lang="en">
<head>
    <title>Code coverage report for lib/wrapPromise.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">lib/</a> wrapPromise.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (cb) {
    return promise.then(<span class="fstat-no" title="function not covered" >function(args) {</span>
<span class="cstat-no" title="statement not covered" >      if (R.isArrayLike(args) &amp;&amp; !options.no_spread) {</span>
...
<span class="cstat-no" title="statement not covered" >          R.apply(R.partial(cb, [null]), args);</span>
        });
      } else {
<span class="cstat-no" title="statement not covered" >        setImmediate(<span class="fstat-no" title="function not covered" >function() {</span></span>
<span class="cstat-no" title="statement not covered" >          cb(null, args);</span>
        });
      }
    }).catch(function(err) {
