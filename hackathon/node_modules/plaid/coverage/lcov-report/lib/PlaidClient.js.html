...
<html lang="en">
<head>
    <title>Code coverage report for lib/PlaidClient.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">lib/</a> PlaidClient.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">63.72% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>72/113</span>
      </div>
      <div class='fl pad1y space-right2'>
...
<span class="fstat-no" title="function not covered" >  function(public_token, cb) {</span>
<span class="cstat-no" title="statement not covered" >    return this._authenticatedRequest({</span>
...
<span class="fstat-no" title="function not covered" >  function(access_token, webhook, cb) {</span>
<span class="cstat-no" title="statement not covered" >    return this._authenticatedRequest({</span>
...
<span class="fstat-no" title="function not covered" >  function(access_token, account_id, processor, cb) {</span>
<span class="cstat-no" title="statement not covered" >    var endpoint = processor === 'stripe' ?</span>
...
&nbsp;
Client.prototype.createStripeToken = <span class="fstat-no" title="function not covered" >function(access_token, account_id, cb) {</span>
<span class="cstat-no" title="statement not covered" >  return this.createProcessorToken(access_token, account_id, 'stripe', cb);</span>
};
&nbsp;
...
<span class="fstat-no" title="function not covered" >  function(access_token, start_date, end_date, options, cb) {</span>
<span class="cstat-no" title="statement not covered" >    return this._authenticatedRequest({</span>
...
<span class="cstat-no" title="statement not covered" >      options = R.defaultTo({}, options);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    var self = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return wrapPromise(P.coroutine(<span class="fstat-no" title="function not covered" >function*() {</span></span>
<span class="cstat-no" title="statement not covered" >      var transactions = [];</span>
<span class="cstat-no" title="statement not covered" >      var transactionsCount = 0;</span>
...
<span class="cstat-no" title="statement not covered" >        const transactionsResponse = yield self.getTransactions(</span>
          access_token,
          start_date,
          end_date,
          R.merge(options, {
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        response.accounts = transactionsResponse.accounts;</span>
<span class="cstat-no" title="statement not covered" >        response.item  = transactionsResponse.item;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        transactions = R.concat(</span>
          transactions, transactionsResponse.transactions);
<span class="cstat-no" title="statement not covered" >        transactionsCount += transactionsResponse.transactions.length;</span>
<span class="cstat-no" title="statement not covered" >        if (transactionsCount &gt;= transactionsResponse.total_transactions) {</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      response.total_transactions = transactionsCount;</span>
<span class="cstat-no" title="statement not covered" >      response.transactions = transactions;</span>
&nbsp;
...
<span class="fstat-no" title="function not covered" >  function(access_tokens, days_requested, options, cb) {</span>
<span class="cstat-no" title="statement not covered" >    return this._authenticatedRequest({</span>
...
<span class="fstat-no" title="function not covered" >  function(asset_report_token, account_ids_to_exclude, cb) {</span>
<span class="cstat-no" title="statement not covered" >    return this._authenticatedRequest({</span>
...
<span class="fstat-no" title="function not covered" >  function(asset_report_token, days_requested, options, cb) {</span>
<span class="cstat-no" title="statement not covered" >    return this._authenticatedRequest({</span>
...
<span class="fstat-no" title="function not covered" >  function(asset_report_token, include_insights, cb) {</span>
<span class="cstat-no" title="statement not covered" >    return this._authenticatedRequest({</span>
...
<span class="fstat-no" title="function not covered" >function(asset_report_token, cb) {</span>
<span class="cstat-no" title="statement not covered" >  return this._authenticatedRequest({</span>
...
<span class="fstat-no" title="function not covered" >function(asset_report_token, auditor_id, cb) {</span>
<span class="cstat-no" title="statement not covered" >  return this._authenticatedRequest({</span>
...
<span class="fstat-no" title="function not covered" >  function(audit_copy_token, cb) {</span>
<span class="cstat-no" title="statement not covered" >    return this._authenticatedRequest({</span>
...
<span class="fstat-no" title="function not covered" >  function(count, offset, options, cb) {</span>
<span class="cstat-no" title="statement not covered" >    return this._authenticatedRequest({</span>
...
<span class="fstat-no" title="function not covered" >  function(institution_id, options, cb) {</span>
<span class="cstat-no" title="statement not covered" >    return this._authenticatedRequest({</span>
...
<span class="fstat-no" title="function not covered" > function(query, products, options, cb) {</span>
<span class="cstat-no" title="statement not covered" >    return this._authenticatedRequest({</span>
...
<span class="cstat-no" title="statement not covered" >    return plaidRequest({</span>
      env: this.env
    }, {
      path: '/categories/get'
...
<span class="fstat-no" title="function not covered" >function(access_token, webhook_code, cb) {</span>
<span class="cstat-no" title="statement not covered" >  return this._authenticatedRequest({</span>
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Fri Jul 05 2019 14:59:13 GMT-0700 (Pacific Daylight Time)
</div>
</div>
