...
export { F, T, add, adjust, all, allPass, always, any, anyPass, append, assoc, both, clone, complement, compose, concat, contains, curry, dec, defaultTo, dissoc, divide, drop, dropLast, either, endsWith, equals, filter, find, findIndex, flatten, flip, forEach, fromPairs, groupBy, has, head, identity, ifElse, inc, includes, indexBy, indexOf, init, is, isEmpty, isNil, join, keys, last, lastIndexOf, length, map, match, max, maxBy, merge, min, minBy, modulo, multiply, none, not, nth, omit, partial, partialCurry, path, pathOr, pick, pickAll, pipe, pluck, prepend, prop, propEq, range, reduce, reject, repeat, replace, reverse, sort, sortBy, split, splitEvery, startsWith, subtract, tail, take, takeLast, tap, test, times, toLower, toPairs, toString, toUpper, trim, type, uniq, uniqWith, update, values, without, zip, zipObj };
