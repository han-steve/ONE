...
export default new Vuex.Store({
  ...
  actions: {
    SET_FILTERS_ACTION(context, newFilter) {
      context.commit("SET_FILTERS_MUTATION", newFilter);
    },
    RESET_FILTERS_ACTION(context) {
      context.commit("RESET_FILTERS_MUTATION");
    }
  },
  getters: {
    getCity(state) {
    ...
    getRestrictions(state) {
      return state.filter.restrictions;
    },
    getLayers(state) {
      return state.layers;
    }
